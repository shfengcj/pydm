...
In sample function: self.iteractions is also yield to show the progress bar
modified by Chao-Jun Feng, 2015
"""
    ...
    def sample(self, p0, lnprob0=None, rstate0=None, blobs0=None,
        ...
        * ``blobs`` - (optional) The metadata "blobs" associated with the
        ...
        for i in range(int(iterations)):
            ...
            # Update progress bar
            if self.pbar:
                self.pbar.update(self.iterations)
            ...
            # self.iteractions is also yield to show the progress bar
            # modified by Chao-Jun Feng, 2015
            if blobs is not None:
                # This is a bit of a hack to keep things backwards compatible.
                yield p, lnprob, self.random_state, self.iterations, blobs
            else:
                yield p, lnprob, self.random_state, self.iterations
